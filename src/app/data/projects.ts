...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "谷口朝洋が開発しているソフトウェア「Strecs3D」のロゴデザイン及び展示用パンフレット・ポスターデザインを制作しました。",
    client: "谷口朝洋",
    year: "2025",
    priority: 5,
    content: [
      { type: "image", src: "/images/projects/logo/logo (4).png" },
      { type: "image", src: "/images/projects/graphic/graphic (1).png" },
    ],
  },
  {
    id: "5",
  ...
  },
  {
    ...
    priority: 2,
    content: [
      { type: "image", src: "/images/projects/product/p" },
      { type: "text", body: "a" },
    ],
  },
];